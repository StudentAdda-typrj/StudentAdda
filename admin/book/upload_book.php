                                            ...
                                            <div class="row">
                                                <div class="col-lg-9 mx-auto">
                                                    ...
                                                    <div class="form-group mb-2">
                                                        <input class="form-control" type="file" name="cover_url" id="cover_url" value="<?php echo $book["cover_url"]; ?>" accept="image/*" required>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-9 mx-auto">
                                                    ...
                                                    <div class="form-group mb-2">
                                                        <input class="form-control" type="file" name="index_url" id="index_url" value="<?php echo $book["index_url"]; ?>" accept="image/*" required>
                                                        <div class="invalid-feedback">Please choose an image file.</div>
                                                    </div>
                                                </div>
                                            </div>
