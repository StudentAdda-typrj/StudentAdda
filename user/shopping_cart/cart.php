                                            ...
                                            <?php foreach ($cart_items as $cart_item): ?>
                                                <?php $book = get_uploaded_books_by_id($cart_item["product_id"]); ?>
                                                    <div class="card mb-3 p-3 mt-3 mb-2 border_color cart_page_inner_card">
                                                        ...
                                                        <a href="/user/shopping_cart/delete_book_cart_item?q=<?php echo $cart_item["product_id"]; ?>" class="btn btn-sm btn-secondary mx-auto d-block col-md-2">Remove</a>
                                                    </div>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <?php else: ?>
                                            <?php foreach ($cart_items as $cart_item): ?>
                                                ...
                                                <a href="/user/shopping_cart/delete_accessory_cart_item?q=<?php echo $cart_item["product_id"]; ?>" class="btn btn-sm btn-secondary mx-auto d-block col-md-2">Remove</a>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
