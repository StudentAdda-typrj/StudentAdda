...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card selling_page_ad_card shadow border-0 mb-5 rounded-4">
                        ...
                        <div class="row">
                            <div class="col-lg-9 mx-auto">
                                ...
                                <a href="" class="text-decoration-none">
                                    <div class="card mt-2 rounded-0 selling_page_ad_card">
                                        <div class="card-body">
                                ...
                                <a href="" class="text-decoration-none">
                                    <div class="card rounded-0 selling_page_ad_card">
                                        <div class="card-body">
