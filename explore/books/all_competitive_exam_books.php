<?php
	$page_title = "All Competitive Exam Books";
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card explore_page_card_border my-3">
                <div class="card-body">
                    <h4 class="bold mt-0 text-decoration-underline">Competitive Exam Books</h4>
                    <div class="row mt-4">
                        <?php if ($exam_books = get_all_competitive_exam_books()): ?>
