    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card selling_page_ad_card border-0 mb-5 rounded-4">
                <h2 class="text-center bold pt-1">TERMS OF USE</h2>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <p class="text-start">
                                ...
                                calls can be stopped by the user if required by following the steps given in Choice/Opt-out below.</p>
                            <p class="text-start">The information of your browser along with your IP address is stored in the form of a “cookie”. This makes it easy 
                            ...
                            <p class="text-start fw-bold">Sharing of Information</p>     
                            <p class="text-start">
