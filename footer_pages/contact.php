<?php
    ...
    if(isset($_POST["contact_button"]))
    {
        ...
        smtp_mailer_to_admin_or_user('studentadda.official@gmail.com','New Query',"<div><strong>Sender Name :</strong> $name</div><div><strong>Sender Email :</strong> $email_address</div><div><strong class='bold'>Contact Number :</strong> $contact</div><div><strong class='bold'>Message :</strong> $message</div>");
