<?php
    $page_title = "Rent Payment Status";
            ...
            <?php
                ...
                if ($success === true)
                {
                    ...
                    if(isset($_POST['razorpay_payment_id']))
                    {
                        ...
                        $sql="SELECT count(*) from rent where transaction_id=:transaction_id";
                        $stmt=$db->prepare($sql);
                        ...
                        if($transaction_id!='')
                        {
                            if($countts<=0)
                            {
                                $sql="INSERT INTO rent (user_id, duration, product_id, amount,product_type, transaction_id, status) VALUES (:user_id, :duration, :product_id, :amount, :product_type, :transaction_id, :status)";
                                $stmt=$db->prepare($sql);
